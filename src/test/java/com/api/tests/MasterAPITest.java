...
public class MasterAPITest {
	...
	@Story("Master API should display OEM details , warranty status etc etc")
	@Description("Verify if Master API should display OEM details , warranty status,Product type")
