...
public class HikariCPDemo {
	...
	public static void main(String[] args) throws SQLException {
		...
		hikariConfig.setPoolName("Phoenix Test Automation");
		...
		ResultSet  rs= statement.executeQuery("SELECT first_name ,last_name ,mobile_number  from tr_customer where last_name ='kurhade'\r\n"
				+ "");
		while(rs.next()) {
